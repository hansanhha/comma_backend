...
import com.know_wave.comma.comma_backend.security.service.AccountUserDetailsService;
...
public class SecurityComponentConfig {
    ...
    public SecurityComponentConfig(UserDetailsService userDetailsService) {
